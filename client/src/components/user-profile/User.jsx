        ...
        <div className="userInfo">
          ...
          <div className="user-details">
            ...
            <div className="user-college">
              college name details updated as with backend calls
            </div>
            <div className="user-bio">
              extra details user weant to display below name- just like linkedin
            </div>
      ...
      <div className="user-experience">
        ...
        <div className="exp-details">
          <div
            ...
            onClick={() => {
              setToggleExperienceDesc(!toggleExperienceDesc);
            }}
          >
          ...
          {toggleExperienceDesc && (
            <div className="exp-desc">
              ...
              illo nostrum dicta veniam accusamus, incidunt vel. Saepe maiores
              velit assumenda ex dolorem voluptatem distinctio. Tempora,
              praesentium veniam distinctio eos deleniti necessitatibus
              blanditiis ipsam sunt quod fuga? Dolores exercitationem nobis
              ratione quia magnam neque eligendi, ullam, veniam numquam quos
              adipisci unde?
              <li> </li>
              <li> </li>
            </div>
      ...
      <div className="user-projects">
        ...
        <div className="project-details">
          <div
            ...
            onClick={() => {
              setToggleProjectDesc(!toggleProjectDesc);
            }}
          >
